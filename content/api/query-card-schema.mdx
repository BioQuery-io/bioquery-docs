...
| Field | Type | Description |
|-------|------|-------------|
| `data_type` | string | Data type: `expression`, `mutation`, `cnv`, `unclear` |
| `analysis_type` | string | Analysis type: `differential_expression`, `mutation_frequency`, `survival_analysis`, `pan_cancer_expression`, `correlation`, `unclear` |
...
| Field | Type | Description |
|-------|------|-------------|
| `name` | string | Data source name (e.g., `"TCGA"`) |
