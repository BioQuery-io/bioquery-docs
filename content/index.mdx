...
| **Pan-Cancer Expression** | Gene expression across all 33 cancers | "Show DDR1 across all cancers" |
| **Gene Signatures** | MSigDB pathway scores (33K+ signatures) | "EMT signature in breast cancer" |
| **Gene Correlation** | Correlate two genes | "Correlate DDR1 and MYC in BRCA" |
| **Cell Line Expression** | Gene expression in CCLE cell lines | "DDR1 in lung cancer cell lines" |
